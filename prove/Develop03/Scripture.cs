...
class Scripture
{
    ...
    public Scripture()
    {
        ...
        Reference r1 = new Reference("Deuteronomy", 32, 39);
        ...
        Reference r2 = new Reference("1 Nephi", 3, 7);
        ...
        Reference r4 = new Reference("2 Nephi", 32, 3);
        ...
        Reference r5 = new Reference("Doctrine and Covenants", 82, 10);
        ...
        Reference r6 = new Reference("Doctrine and Covenants", 88, 118);
        ...
        Reference r7 = new Reference("Helaman", 5, 12);
    ...
    public Reference getScreenScripture(int referenceNumber)
    {
        ...
        return _reference[referenceNumber];
    }
